...
useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titre}>👑 Espace Admin</Text>
      <Text style={styles.sousTitre}>Panneau de contrôle. Bienvenue {nom} !</Text>

      <View style={styles.grille}>
        <TouchableOpacity style={styles.carte}>
          <Text style={styles.icone}>👥</Text>
          <Text style={styles.texteCarte}>Utilisateurs</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.carte}>
          <Text style={styles.icone}>📚</Text>
          <Text style={styles.texteCarte}>Contenu</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.carte}>
          <Text style={styles.icone}>🧠</Text>
          <Text style={styles.texteCarte}>Réponses IA</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.carte}>
          <Text style={styles.icone}>📊</Text>
          <Text style={styles.texteCarte}>Statistiques</Text>
        </TouchableOpacity>
      </View>
