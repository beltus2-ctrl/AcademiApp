...
useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titre}>📚 Espace Étudiant</Text>
      <Text style={styles.sousTitre}>Bienvenue {nom} !</Text>

      <View style={styles.grille}>
        <TouchableOpacity style={styles.carte}>
          <Text style={styles.icone}>📸</Text>
          <Text style={styles.texteCarte}>Mes Cours</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.carte}>
          <Text style={styles.icone}>🧠</Text>
          <Text style={styles.texteCarte}>Quiz</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.carte}>
          <Text style={styles.icone}>📝</Text>
          <Text style={styles.texteCarte}>Examens</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.carte}>
          <Text style={styles.icone}>💬</Text>
          <Text style={styles.texteCarte}>Chat</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.carte}>
          <Text style={styles.icone}>📅</Text>
          <Text style={styles.texteCarte}>Planning</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.carte}>
          <Text style={styles.icone}>📞</Text>
          <Text style={styles.texteCarte}>Appel Prof</Text>
        </TouchableOpacity>
      </View>
